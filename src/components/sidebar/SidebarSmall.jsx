...
const SidebarSmall = ({
  ...
  return (
    <MobileSidebarPortal
      ...
      topOffset={64}
    >
      {/* This is ONLY the content — portal handles backdrop & positioning */}
      <>
        {/* Dashboard */}
        <div className="pb-3 ml-6">
          <a
            href="#"
            className="flex items-center font-semibold gap-2 hover:text-blue-500 transition-colors"
          >
            <svg
        ...
        <Category
          ...
          onToggle={() => setIndexOpen(indexOpen === 0 ? null : 0)}
        />
        ...
        <Category
          ...
          onToggle={() => setIndexOpen(indexOpen === 1 ? null : 1)}
        />
        ...
        <Category
          ...
          onToggle={() => setIndexOpen(indexOpen === 2 ? null : 2)}
        />

        <div className="flex justify-center pt-8 text-sm text-gray-500">
          <span>Current Version: </span>
          <span className="font-bold ml-1">1.1</span>
        </div>
      </>
    </MobileSidebarPortal>
  );
