...
const SidebarLarge = ({ sidebarOpen, indexOpen, setIndexOpen }) => {
  return (
    <div>
      <div
        className={`cursor-pointer hidden pt-4 lg:block transition-all duration-300
      ...
      >
        <div className="px-2 text-gray-500  ">
          ...
          <div className=" py-4 ml-6.5">
            <button className="w-40 flex justify-between   ">
              ...
              >
                ...
                <span className={`${!sidebarOpen && "hidden"}`}>Packages</span>
              </a>
            </button>
          </div>
          <div className=" py-4 ml-6.5">
          ...
          <div className=" flex items-center font-semibold justify-center pt-6 hover:text-blue-500 active:text-blue-500">
            <h1 className={` ${!sidebarOpen && "hidden"}`}>Current Version:</h1>
            <h1>1.1</h1>
          </div>
        </div>
      </div>
